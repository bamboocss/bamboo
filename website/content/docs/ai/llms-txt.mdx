...
- [`/docs/overview/getting-started.mdx`](/docs/overview/getting-started) - Raw markdown for the getting started page
- [`/docs/concepts/recipes.mdx`](/docs/concepts/recipes) - Raw markdown for the recipes documentation
- [`/docs/theming/tokens.mdx`](/docs/theming/tokens) - Raw markdown for the tokens documentation
...
code suggestions and documentation for Bamboo CSS.

[Read more about @Docs in Cursor](https://docs.cursor.com/context/@-symbols/@-docs)

### Windsurf

Reference the LLMs.txt files using `@` or in your `.windsurfrules` files to enhance Windsurf's understanding of Bamboo
CSS.
