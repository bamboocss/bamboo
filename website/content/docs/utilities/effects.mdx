---
title: Effects
description: Bamboo provides utilities or style properties for applying various visual effects to elements.
---

Bamboo offers a range of utilities and style properties for applying visual effects to elements. These effects include
