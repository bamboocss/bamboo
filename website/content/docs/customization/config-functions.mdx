...
Function for [mixin](/docs/theming/mixins) definitions. Replaces `defineTextStyles`, `defineLayerStyles` and
`defineAnimationStyles`, which differed only in which css properties the value could set.
