...
Bamboo offers two similar ways to style components. The first is `cva`, which lets you name the styles and add variants.
...
export const Demo = (props) => <div {...props} className={demo()} />
```
