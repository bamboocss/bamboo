...
- `functionExamples` – examples of how to use the animation style in the `css` function

The declarations themselves are not part of the spec. If no animation styles are configured in your `bamboo.config.ts`
file, this file will contain an empty data array.
