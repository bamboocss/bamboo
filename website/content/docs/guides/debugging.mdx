...
🎋 debug [config:path] /Users/astahmer/dev/open-source/bamboo-clone/website/bamboo.config.ts
🎋 debug [ast:import] Found import { css } in /Users/astahmer/dev/open-source/bamboo-clone/website/theme.config.tsx
🎋 debug [ast:Icon] { kind: 'component' }
🎋 debug [ast:css] { kind: 'function' }
🎋 debug [hrtime] Parsed /Users/astahmer/dev/open-source/bamboo-clone/website/theme.config.tsx (9.66ms)
🎋 debug [ast:import] Found import { css } in /Users/astahmer/dev/open-source/bamboo-clone/website/src/DEFAULT_THEME.tsx
...
🎋 debug [hrtime] Parsed /Users/astahmer/dev/open-source/bamboo-clone/website/src/DEFAULT_THEME.tsx (4.51ms)
🎋 debug [ast:import] No import found in /Users/astahmer/dev/open-source/bamboo-clone/website/src/constants.tsx
🎋 debug [hrtime] Parsed /Users/astahmer/dev/open-source/bamboo-clone/website/src/constants.tsx (4.23ms)
🎋 debug [ast:import] Found import { css } in /Users/astahmer/dev/open-source/bamboo-clone/website/src/index.tsx
🎋 debug [ast:css] { kind: 'function' }
```
...
`bamboo codegen` and `bamboo debug` commands to generate a flamegraph of the whole process, which will allow you (or us as
maintainers) to see which part of the process is taking the most time.

This will generate a `bamboo-{command}-{timestamp}.cpuprofile` file in the current working directory, which can be opened
...
If the issue persists, you can try looking for it in the [issues](https://github.com/chakra-ui/bamboo/issues) or in the
[discord](https://discord.gg/VQrkpsgSx7). If you can't find it, please create a minimal reproduction and submit
[a new github issue](https://github.com/chakra-ui/bamboo/issues/new/choose) so we can help you.
