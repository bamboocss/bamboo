...
> **Note 🚨:** By default, Next.js attaches the className for the fonts to the `<body>` element, for bamboo to
...
This is the option to reach for rather than writing `@font-face` into [`globalCss`](/docs/references/config#globalcss).
...
`globalCss`, the name is a string Bamboo has never seen, and under
...
You can also use [globalVars](/docs/concepts/writing-styles#global-vars) in your bamboo config to define the variables.
