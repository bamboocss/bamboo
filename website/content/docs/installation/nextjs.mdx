...
Setting up Bamboo CSS with Next.js is straightforward. Follow the steps below to get started.
...
`bamboo init --postcss` command will automatically create a `postcss.config.js` file at the root of your project with
the following code:
