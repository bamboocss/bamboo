...
This guide shows you how to set up Bamboo CSS in a Preact project using PostCSS.
...
Make sure that all of the paths of your Preact components are included in the `include` section of the `bamboo.config.ts`
file.
