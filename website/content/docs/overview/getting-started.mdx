...
Bamboo is a styling engine that generates styling primitives to author atomic CSS and recipes in a type-safe and readable
manner.
...
- [Using PostCSS](/docs/installation/postcss): (**Recommended**) Installing Bamboo as a PostCSS plugin is the recommended
...
You can use the [online playground](https://play.bamboo-css.com) to get a taste of what Bamboo can do.

- See the live results of your JSX code
- Inspect what bamboo can extract using static analysis from your code
