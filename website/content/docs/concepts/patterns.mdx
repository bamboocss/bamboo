...
To use the pattern in JSX, you need to set the `jsxFramework` property in the config. When this is set, Bamboo will emit
...
Then you can create a new component that uses the `PageScrollable` component and Bamboo will track the usage of the
