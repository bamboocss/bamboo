...
[remove-unused-css-vars](https://github.com/chakra-ui/bamboo/blob/main/sandbox/vite-ts/remove-unused-css-vars.ts) and
[remove-unused-keyframes](https://github.com/chakra-ui/bamboo/blob/main/sandbox/vite-ts/remove-unused-keyframes.ts)
files.
