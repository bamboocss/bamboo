...
[remove-unused-css-vars](https://github.com/bamboocss/bamboo/blob/main/sandbox/vite-ts/remove-unused-css-vars.ts) and
[remove-unused-keyframes](https://github.com/bamboocss/bamboo/blob/main/sandbox/vite-ts/remove-unused-keyframes.ts)
files.
