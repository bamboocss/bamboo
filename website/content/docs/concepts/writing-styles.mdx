...
The `hash` option shortens extraction-only semantic class names and CSS variables. Vite uses `hash` for compiler-owned
atoms; this setting is still useful when CSS variable names should also be hashed.
