...
| Can accept a runtime variant selection under Vite    | ✅ finite axes become a precompiled decision table       | ✅ finite axes become a precompiled decision table                   |
| Can use a responsive object as the runtime selection | ❌ put responsiveness in the recipe's style declarations | ❌ put responsiveness in the recipe's style declarations             |
