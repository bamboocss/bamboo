...
Cascade layers, `cva`, recipes and patterns are unaffected. Note that
[`@bamboocss/vite`](/docs/guides/source-transformation) declines element splitting under `grouped`, since that
