  ...
  expect(tokenJs()).toMatchInlineSnapshot(
    ...
    "const tokens = {
      ...
      "colors.deep.test.yam": {
        "value": "%555",
        "variable": "var(--colors-deep-test-yam)"
      },
      "colors.deep.test.pool.poller": {
        "value": "#fff",
        "variable": "var(--colors-deep-test-pool-poller)"
      },
      "colors.deep.test.pool.tall": {
        "value": "$dfdf",
        ...
        theme: {
          ...
          semanticTokens: {
            colors: {
              ...
              blueRef: { value: 'token(colors.blue)' },
              redRef: { value: 'token(colors.red)' },
            },
          },
        },
      }),
