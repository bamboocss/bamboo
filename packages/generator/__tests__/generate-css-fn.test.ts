  ...
  test('basic', () => {
    expect(generateCssFn(createContext())).toMatchInlineSnapshot(`
      ...
      export declare const cssLeaf: (prefix: string, prop: string, value: unknown) => string;",
        "js": "import { cloneStyles, createCss, createMergeCss, hypenateProperty, leafClass, memo, viewTransitionClassName, withoutSpace } from '../helpers.mjs';
...
describe('generate string-literal css-fn', () => {
  ...
  test('matches snapshot', () => {
    expect(generateStringLiteralCssFn(createContext({ syntax: 'template-literal' }))).toMatchInlineSnapshot(`
      ...
      export declare const css: CssFunction;",
        "js": "import { astish, cloneStyles, createCss, isObject, mergeProps, withoutSpace } from '../helpers.mjs';
