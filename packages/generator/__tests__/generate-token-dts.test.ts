...
test('[dts] full token types', () => {
  expect(generateTokenTypes(createContext())).toMatchInlineSnapshot(`
    ...
    export type ZIndexToken = "hide" | "base" | "docked" | "dropdown" | "sticky" | "banner" | "overlay" | "modal" | "popover" | "skipNav" | "toast" | "tooltip"
...
test('[dts] negative tokens', () => {
  ...
  expect(tokens).toMatchInlineSnapshot(`
    ...
    export type LiteralToken = "spacing.test.test"
