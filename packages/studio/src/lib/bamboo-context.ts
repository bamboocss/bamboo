import { flatten } from '@bamboocss/shared'
import { Token, TokenDictionary } from '@bamboocss/token-dictionary'
import type { TokenDataTypes } from '@bamboocss/types'
import { config, themes as configThemes } from 'virtual:bamboo'
