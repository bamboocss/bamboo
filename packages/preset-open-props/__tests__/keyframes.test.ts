...
describe('Open Prop preset transforms', () => {
  test('Should transform keyframes and animations correctly', () => {
    expect(easings).toMatchInlineSnapshot(`
      {
        ...
        "elastic-1": {
          "value": "token(easings.elastic-out-1)",
        },
        "elastic-2": {
          "value": "token(easings.elastic-out-2)",
        },
        "elastic-3": {
          "value": "token(easings.elastic-out-3)",
        },
        "elastic-4": {
          "value": "token(easings.elastic-out-4)",
        },
        "elastic-5": {
          "value": "token(easings.elastic-out-5)",
        },
        "elastic-in-1": {
        ...
        "squish-1": {
          "value": "token(easings.elastic-in-out-1)",
        },
        "squish-2": {
          "value": "token(easings.elastic-in-out-2)",
        },
        "squish-3": {
          "value": "token(easings.elastic-in-out-3)",
        },
        "squish-4": {
          "value": "token(easings.elastic-in-out-4)",
        },
        "squish-5": {
          "value": "token(easings.elastic-in-out-5)",
        },
        "step-1": {
          "value": "steps(2)",
        },
    ...
    expect(animations).toMatchInlineSnapshot(`
      {
        "blink": {
          "value": "blink 1s token(easings.out-3) infinite",
        },
        "bounce": {
          "value": "bounce 2s token(easings.squish-2) infinite",
        },
        "fade-in": {
          "value": "fade-in .5s token(easings.3)",
        },
        "fade-in-bloom": {
          "value": "fade-in-bloom 2s token(easings.3)",
        },
        "fade-out": {
          "value": "fade-out .5s token(easings.3)",
        },
        "fade-out-bloom": {
          "value": "fade-out-bloom 2s token(easings.3)",
        },
        "float": {
          "value": "float 3s token(easings.in-out-3) infinite",
        },
        "ping": {
          "value": "ping 5s token(easings.out-3) infinite",
        },
        "pulse": {
          "value": "pulse 2s token(easings.out-3) infinite",
        },
        "scale-down": {
          "value": "scale-down .5s token(easings.3)",
        },
        "scale-up": {
          "value": "scale-up .5s token(easings.3)",
        },
        "shake-x": {
          "value": "shake-x .75s token(easings.out-5)",
        },
        "shake-y": {
          "value": "shake-y .75s token(easings.out-5)",
        },
        "shake-z": {
          "value": "shake-z 1s token(easings.in-out-3)",
        },
        "slide-in-down": {
          "value": "slide-in-down .5s token(easings.3)",
        },
        "slide-in-left": {
          "value": "slide-in-left .5s token(easings.3)",
        },
        "slide-in-right": {
          "value": "slide-in-right .5s token(easings.3)",
        },
        "slide-in-up": {
          "value": "slide-in-up .5s token(easings.3)",
        },
        "slide-out-down": {
          "value": "slide-out-down .5s token(easings.3)",
        },
        "slide-out-left": {
          "value": "slide-out-left .5s token(easings.3)",
        },
        "slide-out-right": {
          "value": "slide-out-right .5s token(easings.3)",
        },
        "slide-out-up": {
          "value": "slide-out-up .5s token(easings.3)",
        },
        "spin": {
    ...
    expect(semanticAnimations).toMatchInlineSnapshot(`
      {
        "fade-in-bloom": {
          "value": {
            "_dark": "fade-in-bloom-dark 2s token(easings.3)",
          },
        },
        "fade-out-bloom": {
          "value": {
            "_dark": "fade-out-bloom-dark 2s token(easings.3)",
          },
        },
      }
    `)
