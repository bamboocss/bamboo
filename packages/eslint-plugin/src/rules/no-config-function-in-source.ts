...
import { getAncestor, getImportSpecifiers, hasPkgImport, isBambooConfigFunction, isValidFile } from '../utils/helpers'
...
const rule = createRule({
  ...
  meta: {
    docs: {
      description: 'Prohibit the use of config functions outside the Bamboo config file.',
    },
    hasSuggestions: true,
    messages: {
